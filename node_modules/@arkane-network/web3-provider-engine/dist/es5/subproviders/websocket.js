...
var WebsocketSubprovider = /*#__PURE__*/function (_Subprovider) {
  ...
  function WebsocketSubprovider(_ref) {
    ...
    _this._ignoredRpcCalls.add("eth_coinbase");

    _this._ignoredRpcCalls.add("eth_accounts");

    _this._ignoredRpcCalls.add("eth_sendTransaction");

    _this._ignoredRpcCalls.add("eth_sendRawTransaction");

    _this._ignoredRpcCalls.add("eth_sign");

    _this._ignoredRpcCalls.add("eth_signTransaction");

    _this._ignoredRpcCalls.add("eth_signTypedData");

    _this._ignoredRpcCalls.add("eth_signTypedData_v3");

    _this._ignoredRpcCalls.add("eth_signTypedData_v4");

    _this._ignoredRpcCalls.add("personal_sign");

    _this._ignoredRpcCalls.add("eth_decryptMessage");

    _this._ignoredRpcCalls.add("encryption_public_key");

    _this._ignoredRpcCalls.add("personal_ecRecover");

    _this._ignoredRpcCalls.add("parity_postTransaction");

    _this._ignoredRpcCalls.add("parity_checkRequest");

    _this._ignoredRpcCalls.add("parity_defaultAccount"); // Called when a backoff timeout has finished. Time to try reconnecting.
